locals {
  ...
  extra_manifests = concat(var.cluster.extra_manifests, [
    "https://github.com/kubernetes-sigs/gateway-api/releases/download/${var.cluster.gateway_api_version}/experimental-install.yaml",
...
data "talos_machine_configuration" "this" {
  ...
  config_patches = compact([
    ...
    each.value.datastore != null ?
    templatefile("${path.module}/machine-config/datastore.yaml.tftpl", {
